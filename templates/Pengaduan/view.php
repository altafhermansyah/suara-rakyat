...
$status = ['lapor' => 'Baru', 'proses' => 'Proses', 'selesai' => 'Selesai'];
?>
...
<div class="view card card-primary card-outline">
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap">
            ...
            <tr>
                <th><?= __('User') ?></th>
                <td><?= $pengaduan->has('user') ? $this->Html->link($pengaduan->user->nama, ['controller' => 'Users', 'action' => 'view', $pengaduan->user->id]) : '' ?></td>
            </tr>
            <tr>
                <th><?= __('Id') ?></th>
